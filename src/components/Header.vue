<template>
    <div class="w-full h-screen bg-cover" style="background-image: url('/bg-4.webp')">
        <nav fixed w-full top-0>
            <div
                class="font-sans bg-transparent backdrop-blur-xl mt-0 p-2  z-50 flex justify-between rounded-b-lg shadow-xl ">
                ...
                <div class="justify-end flex z-20">
                    ...
                    <div class=" mx-1 flex">
                        <a  :title="$t('global.toggle_langs')" @click="toggleLocales()">
                            <i i-carbon-earth-filled />{{ $t('global.toggle_langs') }}
                        </a>
                    </div>
                </div>
            </div>
